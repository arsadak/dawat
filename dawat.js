...
function first(){
    document.getElementById("promoimage").src="promo_slide_2.jpg"
}

function second(){
    document.getElementById("promoimage").src="promo_slide_3.jpg"
}

function third(){
    document.getElementById("promoimage").src="promo_slide_1.jpg"
}
...
window.addEventListener('scroll',function(){
    ...
    if(window.pageYOffset >= 42){
        ...
        navimage.src = "main_logo_black.png";
    }else{
        navbar.classList.remove('navbar_sticky');
        navimage.src = "main_logo.png"
    }
})